...
class Module
{
    public function onBootstrap($e)
    {
        ...
        if (isset($config['zf-oauth2']['storage_settings']['default_documents_enable'])
            && $config['zf-oauth2']['storage_settings']['default_documents_enable']) {
            $driver = $config['zf-oauth2']['storage_settings']['default_documents_driver'];
            $chain = $sm->get($config['zf-oauth2']['storage_settings']['driver']);
